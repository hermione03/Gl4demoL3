...
static void draw( void ) {
    ...
    static const GLfloat rouge[] = { 0.7f, 0.0f, 0.0f, 1.0f }, bleu[] = { 0.0f , 0.0f, 0.7f, 1.0f },
        lumpos[] = { -4.0f, 4.0f, 0.0f, 1.0f }, white[] = { 1.0f, 1.0f, 1.0f, 1.0f };
    int i;
    ...
    //glUniform4fv(glGetUniformLocation(_pId, "ambient_color"), 1, white);
    glUniform4fv(glGetUniformLocation(_pId, "couleur"), 1, white);
    ...
    // gl4duLoadIdentityf();
    // gl4duTranslatef( 0.0f, 3.0f, -30.0f );
    // gl4duRotatef( -180.0f, 1.0f, 0.0f, 0.0f );
    // gl4duScalef( 12.0f, 15.0f, 15.0f );
    // gl4duSendMatrices();
    ...
    gl4duLoadIdentityf();
    gl4duTranslatef( 0.0f, 0.0f, -18.0f - 10.0f * cos(M_PI_4) );
    // gl4duRotatef( 0.0f, 1.0f, 0.0f, 0.0f );
